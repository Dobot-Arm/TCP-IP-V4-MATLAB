classdef CRMATLABDemo < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function UIFigureWindowButtonDown(app, event)
            if event.Source.CurrentObject.Tag ~= ""
                app.IsMoveJog=true;
                s = event.Source.CurrentObject.Tag;
                if s == "J1+" || s == "J1-" || s == "J2+" || s == "J2-" || s == "J3+" || s == "J3-" || s == "J4+" || s == "J4-" || s == "J5+" || s == "J5-" || s == "J6+" || s == "J6-" 
                    ...
                    app.LogTextArea.Value{end+1}=char(sprintf("Send:MoveJog(%s,coordtype=1,user=0,tool=0)",event.Source.CurrentObject.Tag));
                    write(app.DashboardClient,"MoveJog("+event.Source.CurrentObject.Tag+",coordtype=1,user=0,tool=0)","char");
                end
            end
        end
        ...
        function ResetRobotButtonPushed(app, event)
            app.LogTextArea.Value{end+1}=['Send:Stop()'];
            write(app.DashboardClient,"Stop()","char");
            pause(1);
            res=read(app.DashboardClient,app.DashboardClient.NumBytesAvailable);
            app.LogTextArea.Value{end+1}=char(sprintf("Receive:%s",res));
        ...
        function DOConfirmButtonPushed(app, event)
            app.LogTextArea.Value{end+1}=char(sprintf("Send:DOInstant(%s,%d)",app.DigitalOutputsIndexEditField.Value,app.DOStatusDropDown.Value));
            write(app.DashboardClient,"DOInstant("+app.DigitalOutputsIndexEditField.Value+","+app.DOStatusDropDown.Value+")","char");
            pause(1);
            res=read(app.DashboardClient,app.DashboardClient.NumBytesAvailable);
            app.LogTextArea.Value{end+1}=char(sprintf("Receive:%s",res));
        end
        ...
        function MovJButtonPushed(app, event)
            app.LogTextArea.Value{end+1}=char(sprintf("Send:MovJ(pose={%f,%f,%f,%f,%f,%f})",app.XEditField.Value,app.YEditField.Value,app.ZEditField.Value,app.RXEditField.Value,app.RYEditField.Value,app.RZEditField.Value));
            write(app.DashboardClient,sprintf("MovJ(pose={%f,%f,%f,%f,%f,%f})",app.XEditField.Value,app.YEditField.Value,app.ZEditField.Value,app.RXEditField.Value,app.RYEditField.Value,app.RZEditField.Value),"char");
        end

        % Button pushed function: MovLButton
        function MovLButtonPushed(app, event)
            app.LogTextArea.Value{end+1}=char(sprintf("Send:MovL(pose={%f,%f,%f,%f,%f,%f})",app.XEditField.Value,app.YEditField.Value,app.ZEditField.Value,app.RXEditField.Value,app.RYEditField.Value,app.RZEditField.Value));
            write(app.DashboardClient,sprintf("MovL(pose={%f,%f,%f,%f,%f,%f})",app.XEditField.Value,app.YEditField.Value,app.ZEditField.Value,app.RXEditField.Value,app.RYEditField.Value,app.RZEditField.Value),"char");
        end

        % Button pushed function: JointMovJButton
        function JointMovJButtonPushed(app, event)
            app.LogTextArea.Value{end+1}=char(sprintf("Send:MovJ(pose={%f,%f,%f,%f,%f,%f})",app.J1EditField.Value,app.J2EditField.Value,app.J3EditField.Value,app.J4EditField.Value,app.J5EditField.Value,app.J6EditField.Value));
            write(app.DashboardClient,"MovJ(joint={"+app.J1EditField.Value+","+app.J2EditField.Value+","+app.J3EditField.Value+","+app.J4EditField.Value+","+app.J5EditField.Value+","+app.J6EditField.Value+"})","char");
        end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Name = 'MATLAB_V4 App';
            ...
            app.FeedBackPortEditField.Position = [610 24 136 27];
            ...
            app.FeedBackPortEditFieldLabel.Position = [511 27 90 22];
            ...
            app.ConnectButton.Text = 'Connect';
            app.ConnectButton.Position = [866 27 100 22];
